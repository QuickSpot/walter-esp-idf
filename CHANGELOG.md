...
## [v1.4.3](https://github.com/QuickSpot/walter-esp-idf/releases/tag/v1.4.3)
...
## [v1.5.0](https://github.com/QuickSpot/walter-esp-idf/releases/tag/v1.5.0) - MAJOR UPDATE
...
- release(1.5.0) [#152](https://github.com/QuickSpot/walter-esp-idf/pull/152)
...
- fix(WalterModem): Retrieving ICCID and eUICCID using getSIMCardID() ([#110](https://github.com/QuickSpot/walter-arduino/pull/126))
